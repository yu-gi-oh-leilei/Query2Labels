...
from models2.backbone import build_backbone
from models2.transformer import build_transformer
...
class Qeruy2Label(nn.Module):
    def __init__(self, backbone, transfomer, num_class):
        ...
        # prototype = '/media/data2/maleilei/MLIC/Query2Labels_base/vis_prototype_embed_file_train.npy'
        # self.prototype = torch.from_numpy(np.load(prototype)

...
def parser_args():
    ...
    parser.add_argument('--dataname', help='dataname', default='coco14', choices=['coco14', 'nus_wide'])
    parser.add_argument('--dataset_dir', help='dir of dataset', default='/media/mlldiskSSD/COCO2014')
   ...
   # data aug
    ...
    parser.add_argument('--remove_norm', action='store_true', default=False,
                        help='remove normalize of input images')
...
def main_worker(args, logger):
    ...
    # for eval only
    # _, mAP = validate(train_loader_prototype, model, criterion, args, logger)
